    ...
    <Swiper
      ...
      <SwiperSlide>
        <div className='item w-full rounded-md overflow-hidden  relative'>
          ...
          <div className='info absolute top-0 -right-[100%] w-[50%] h-[100%] opacity-0 z-50 p-8 flex items-center justify-center flex-col transition-all duration-700'>
            <h4 className='text-[18px] font-[500] text-left w-full mb-3 relative -right-[100%] opacity-0'>
              Big Saving Days Sale
            </h4>
            <h2 className='text-[30px] font-[700] w-full relative -right-[100%] opacity-0'>
